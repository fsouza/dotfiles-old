...
set path=($RBENV/shims ${HOME}/opt/bin ${GOROOT}/bin ${GOPATH}/bin /usr/local/bin /usr/local/sbin ${path} ${HOME}/Projects/dotfiles/bin /usr/local/share/npm/bin ${HOME}/.gem/ruby/2.0.0/bin/)
