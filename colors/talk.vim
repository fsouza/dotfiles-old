...
highlight Conditional ctermfg=19 guifg=#5f00ff
highlight Float ctermfg=200 guifg=#ff00d7
highlight Include ctermfg=19 guifg=#5f00ff
highlight Keyword ctermfg=19 guifg=#5f00ff
highlight Number ctermfg=200 guifg=#ff00d7
highlight PreCondit ctermfg=19 guifg=#5f00ff
highlight Repeat ctermfg=19 guifg=#5f00ff
highlight SpecialComment ctermfg=27 guifg=#005fff
highlight Statement ctermfg=19 guifg=#5f00ff
highlight StorageClass ctermfg=19 guifg=#5f00ff
highlight String ctermfg=200 guifg=#ff00d7
highlight Structure ctermfg=19 guifg=#5f00ff
highlight Todo ctermfg=27 gui=bold guifg=#005fff
highlight Type ctermfg=19 guifg=#5f00ff
highlight Typedef ctermfg=19 guifg=#5f00ff
